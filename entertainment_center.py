...
# Using media.Movie to initiaize a variable, say, toy_story
...
wonder_woman = media.Movie("Wonder woman", "A story about a amazonian" +
                           " goddess on a quest to save the planet !",
                           "https://upload.wikimedia.org/wikipedia/en/e" +
                           "/ed/Wonder_Woman_%282017_film%29.jpg",
...
spiderman_homecoming = media.Movie("Spider-Man: Homecoming", "Spiderman is" +
                                   " back and this time in MCU !",
...
mummy = media.Movie("The Mummy", "A betrayed Egyption Princess, a honest" +
                    " to god (?) soldier ,what can possibly go wrong ?",
...
# Calling the open_movies_function to render the web page
